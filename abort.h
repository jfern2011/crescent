...
/*
 * Note: MS Visual C++ doesn't support ##__VA_ARGS__ to suppress
 *       trailing commas in an empty argument list the way that
 *       GCC does:
 *
 *       #define macro(a, ##__VA_ARGS__)
 *
 *       evaluates to
 *
 *       #define macro(a,)
 *
 *       which obviously leads to syntax errors. As a workaround
 *       use AbortIf_2 for fewer than 3 arguments
 */
